...
void TorqueReporter::SetAxis(dReal x, dReal y, dReal z)
{
...
void TorqueReporter::Dump()
{
    ...
    if (m_DumpStream)
    {
        ...
        dReal tension = mMuscle->GetTension();
        pgd::Vector torque, point, force, centre;
        dReal *forcePoint, *forceDirection;
...
//        else
        ...
        *m_DumpStream << gSimulation->GetTime() << "\t" << tension << "\t"
...
void TorqueReporter::CalculateRotationFromAxis(dReal x, dReal y, dReal z, pgd::Matrix3x3 *R)
{
