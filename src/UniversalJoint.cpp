...
void UniversalJoint::SetUniversalAnchor (dReal x, dReal y, dReal z)
{
...
void UniversalJoint::SetUniversalAxis1(dReal x, dReal y, dReal z)
{
    dVector3 v;
    v[0] = x; v[1] = y; v[2] = z;
    dNormalize3(v);
...
void UniversalJoint::SetUniversalAxis2(dReal x, dReal y, dReal z)
{
    dVector3 v;
    v[0] = x; v[1] = y; v[2] = z;
    dNormalize3(v);
...
void UniversalJoint::SetStartAngleReference1(dReal startAngleReference)
{
    m_StartAngleReference1 = startAngleReference;
}

void UniversalJoint::SetStartAngleReference2(dReal startAngleReference)
{
...
dReal UniversalJoint::GetUniversalAngle1()
{
    return dJointGetHinge2Angle1(m_JointID) + m_StartAngleReference1;
}

dReal UniversalJoint::GetUniversalAngle2()
{
...
dReal UniversalJoint::GetUniversalAngle1Rate()
{
    return dJointGetHinge2Angle1Rate(m_JointID);
}

dReal UniversalJoint::GetUniversalAngle2Rate()
{
